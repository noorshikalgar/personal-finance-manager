    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          customCycleDays: reminder.customCycleDays?.toString() || '',
          nextDate: new Date(reminder.nextDate).toISOString().split('T')[0],
          isExpense: reminder.isExpenseRelated,
          estimatedAmount: reminder.estimatedCost?.toString() || '',
